...
// INPUT:    
// OUTPUT:   
// FUNCTION: Retrieves the data generated by the jar file from the Results folder
...
// INPUT:    
// OUTPUT:   
// FUNCTION: Retrieves the list of read-in files from lachisisDebriefs
...
// INPUT:    
// OUTPUT:   
// FUNCTION: Retrieves the task data from the Tasks_(date).plist file for the 
//			 given date
...
// INPUT:    
// OUTPUT:   
// FUNCTION: Retrieves the title string from the title_(date).txt file in the
//			 results folder
...
// INPUT:    
// OUTPUT:   
// FUNCTION: Writes to a .txt file the data in answer
...
// INPUT:    
// OUTPUT:   
// FUNCTION: Reads in the task file located at taskPath
